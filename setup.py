...
def get_version():
    filepath = os.path.join(os.path.dirname(__file__), "terra_pandas", "version.py")
    if os.path.isfile(filepath):
        # In source distributions or builds, version is available in the generated terra_pandas/version.py file
